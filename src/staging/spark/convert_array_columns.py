...
class ConvertArrayColumnsTask:
    """Pipeline class for converting array columns in BigQuery staging tables"""
    ...
    def _create_spark_session(self):
        ...
        return SparkSession.builder \
            .appName("ConvertArrayColumnsTask") \
            .config(conf=conf) \
            .getOrCreate()
    ...
    def run(self, tables):
        ...
        try:
            for table in tables:
                self.process_table(table["table_name"], table["columns_to_be_"])
...
tables = [
    ...
    {
        "table_name": "routes",
        "columns_to_be_": ["district_ids", "facilities", "locality_ids", "municipality_ids", "pattern_ids", "region_ids", "stop_ids"]
    },
    {
        "table_name": "lines",
        "columns_to_be_": ["district_ids", "facilities", "locality_ids", "municipalitiy_ids", "pattern_ids", "region_ids", "route_ids", "stop_ids"]
    }
]
